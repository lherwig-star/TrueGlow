...
class MockCheckinService implements CheckinService {
  ...
  Future<CheckinAuswertung> auswerten({
    ...
    return CheckinAuswertung(
      ...
      // Das Zwischenfazit gehoert zum Wirkungs-Check. `mitFortschrittsfoto`
      // taugt dafuer nicht mehr als Bedingung: Ein Foto bietet die App seit
      // DECISIONS 48 bei jedem Check-in an.
